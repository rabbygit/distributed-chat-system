...
export class RedisAdapter extends Adapter {
   ...
   * @private
   */
  public onmessage(pattern, channel, msg) {
    channel = channel.toString();

    console.log("onmessage called on channel --> ",channel)
    console.log("onmessage called on from --> ",pattern)
 ...
 */
  ...
  private async onrequest(channel, msg) {
    ...
    switch (request.type) {
      ...
      case RequestType.REMOTE_JOIN:
        console.log('Socket join called')
        if (request.opts) {
          const opts = {
  ...
  public remoteJoin(id: SocketId, room: Room): Promise<void> {
    ...
    console.log("remoteJoin called id -> ", id, "ROOM  ", room)
  ...
  public remoteLeave(id: SocketId, room: Room): Promise<void> {
    const requestId = uid2(6);
    console.log("remoteLeave called")
  ...
  public remoteDisconnect(id: SocketId, close?: boolean): Promise<void> {
    const requestId = uid2(6);
    console.log("remoteDisconnect called")
